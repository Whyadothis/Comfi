...
*/
  ...
  run: async (bot, interaction, args) => {
		const npm = interaction.options.getString('npm');
...
new EmbedBuilder({ // Edit this embed to your liking such as the Color. Using objects happens to make your code more organized.
				author: {
					name: 'NPM',
